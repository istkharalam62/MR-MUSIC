            ...
            [
                [
                    InlineKeyboardButton(
                        "✨𝚂𝚄𝙿𝙿𝙾𝚁𝚃✨", url=f"https://t.me/THUNDER_NETWORKS"
                    ),
                    InlineKeyboardButton(
                        "✨𝙾𝙵𝙵𝙸𝙲𝙴✨", url=f"https://t.me/MUNNA_BHAIYA_CHAT_GRUP"
                    ),
                ]
            ]
        ),
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "✨𝚂𝚄𝙿𝙿𝙾𝚁𝚃✨", url=f" https://t.me/MUNNA_BHAIYA_CHAT_GRUP"
                    ),
                    InlineKeyboardButton(
                        "✨𝙾𝙵𝙵𝙸𝙲𝙴✨", url=f"https://t.me/THUNDER_NETWORKS"
                    ),
                ]
            ]
        ),
